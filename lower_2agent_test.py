...
from rl_utils.env import MapEnv, dxdy_dict, ODMapEnv
...
# actor_net.load_state_dict(torch.load('lower_model/SAC_200_eps_inrealmap_419.pth'))
...
env = ODMapEnv(mapdata, traj, test_mode=True, testid_start=testid_start, test_num=num_tests,
...
for i in range(num_tests):
    ...
    t_upper = traj.loc[i+testid_start, 'time']
